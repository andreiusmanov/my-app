package com.example.application.views.personform3;
...
@PageTitle("Person Form3")
@Route(value = "person-form3", layout = MainLayout.class)
public class PersonForm3View extends Composite<VerticalLayout> {

    public PersonForm3View() {
        Tabs tabs = new Tabs();
